...

          {
            this.state.admin[0].name
              ? <View style={styles.topContainer}>
                  ...
                  <FormInput placeholder='Search for trips' placeholderTextColor='#ffd391' onChangeText={this.search} containerStyle={styles.search, {width: 230, borderBottomColor: '#ffd391'}} inputStyle={{color: '#ffd391', marginTop: 15}} selectionColor={{color:'#ffd391'}}/>
                  {/* <SearchBar
                    round
                    lightTheme
